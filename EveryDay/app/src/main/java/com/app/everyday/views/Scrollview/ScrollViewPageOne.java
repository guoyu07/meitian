...
/**
 * Author：YJQ on 2016/1/18 12:17
 * Eamil：yujiaqi@fenzotech.com
 * Description:
 */
public class ScrollViewPageOne extends ScrollView {

    private int mScreenHeight;
    public float oldY;
    private int t;//t表示本scrollview向上滑动的距离

    public ScrollViewPageOne(Context context) {
        this(context, null);
    }

    public ScrollViewPageOne(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollViewPageOne(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                float Y = ev.getY();//X,Y 相对于容器的位置坐标
                float Ys = Y - oldY;
